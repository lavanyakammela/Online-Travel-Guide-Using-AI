...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'lavanyakammela0711@gmail.com',
...
app.post('/api/send-otp', (req, res) => {
    ...
    const mailOptions = {
        from: 'lavanyakammela0711@gmail.com',
        to: email,
        ...
        fs.readFile(resetTokensPath, 'utf8', (err, tokensData) => {
            ...
            fs.writeFile(resetTokensPath, JSON.stringify(tokens), (err) => {
                ...
                const transporter = nodemailer.createTransport({
                    service: 'Gmail',
                    auth: {
                        user: 'lavanyakammela0711@gmail.com', // replace with your email
                ...
                const mailOptions = {
                    from: 'lavanyakammela0711@gmail.com', // Update this to your email
                    to: email,
